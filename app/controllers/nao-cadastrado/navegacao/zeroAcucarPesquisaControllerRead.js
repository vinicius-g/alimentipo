...
class ProdutosZeroAcucarPesquisaController {
    constructor() {
    ...
    async acessarPagina(req, res) {
        ...
        let produtos = await produtoModel.pesquisaProdutosComRestricao("Zero açúcar", paginaAtual, pesquisa);
        let quantidadeProdutos = await produtoModel.contarProdutosComRestricaoPesquisados("Zero açúcar", pesquisa);
...
const ProdutosZeroAcucarPesquisaControllerRead = new ProdutosZeroAcucarPesquisaController();

module.exports = ProdutosZeroAcucarPesquisaControllerRead;